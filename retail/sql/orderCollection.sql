...
create or replace package order_collection authid current_user as
   procedure insert_order (
      in_order in json_object_t
   );
   function get_order (
...
create or replace package body order_collection as
  -- Private constants
   ...
   function get_collection return soda_collection_t is
   begin
   ...
   procedure delete_all_orders is
      status     number;
      collection soda_collection_t;
   begin
    -- write the order object
   ...
   procedure create_collection is
      collection soda_collection_t;
   begin
      collection := dbms_soda.create_collection(
         collection_name => collection_name,
         metadata        => collection_metadata
      );
   end create_collection;

   procedure drop_collection is
      status number;
   begin

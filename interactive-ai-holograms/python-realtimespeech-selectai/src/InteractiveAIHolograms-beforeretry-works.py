...
class SpeechListener(RealtimeClientListener):
    def on_result(self, result):
        ...
        if result["transcriptions"][0]["isFinal"]:
            ...
            triggers = ["yo dude", "hey oracle", "a oracle", "they oracle", "hey db", "hey deebee", "a db", "adb", "they deebee", "hey deebee", "hey there"]
            ...
            try:
                if handleContainsLogic(cummulativeResult.lower(), contains_logic):
                    ...
                    if result and isinstance(result[0], oracledb.LOB):
                        ...
                        if narrate_sorry_noselect_message in latest_answer:
                            latest_answer = "I'm sorry, I couldn't find an answer for that in the database. Try asking the LLM directly by saying, 'use chat'"

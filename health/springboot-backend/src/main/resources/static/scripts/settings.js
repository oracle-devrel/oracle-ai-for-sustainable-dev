...
function initSdk(name) {
    ...
    const chatWidgetSettings = {
        URI: 'oda-youraddress.data.digitalassistant.oci.oraclecloud.com/',                               // ODA URI, only the hostname part should be passed, without the https://
        ...
        channelId: 'yourchannelid',                   // Channel ID, available in channel settings in ODA UI, optional if client auth enabled
